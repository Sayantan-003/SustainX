...
// export default function WorkOrderDetailedModal({ workOrder, onClose, onUpdate, onDelete }) {
...
//     { id: "tasks", label: "Tasks", icon: CheckSquare, count: workOrder.checklists?.reduce((acc, cl) => acc + cl.tasks.length, 0) },
//     { id: "photos", label: "Photos", icon: ImageIcon, count: workOrder.photos?.length },
//     { id: "activity", label: "Activity", icon: Clock },
//   ];

//   return (
//     <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
//       <div className="bg-white rounded-2xl shadow-2xl w-full max-w-5xl max-h-[200vh] overflow-hidden flex flex-col">
//         {/* Header */}
//         <div className="bg-white text-black px-6 py-4">
//           <div className="flex items-start justify-between">
//             <div className="flex-1">
//               <div className="flex items-center gap-3 mb-2">
//                 <h2 className="text-2xl font-bold">WO #{workOrder.id.substring(workOrder.id.length - 6)}</h2>
//                 <span className={`px-3 py-1 rounded-full text-xs font-semibold border ${getStatusColor(workOrder.status)}`}>
//                   {workOrder.status}
//                 </span>
//               </div>
//               <h3 className="text-lg font-medium text-blue-60">{workOrder.title}</h3>
//             </div>
...
//                       <p className="text-sm font-semibold text-blue-900">{formatShortDate(workOrder.startDate)}</p>
//                     </div>
//                   </div>
//                 </div>
...
//                     </div>
//                     <div>
//                       <p className="text-xs text-purple-600 font-medium">Due Date</p>
//                       <p className="text-sm font-semibold text-purple-900">{formatShortDate(workOrder.dueDate)}</p>
//                     </div>
//                   </div>
//                 </div>
...
//                       <p className="text-sm font-semibold text-amber-900">{workOrder.duration || 0} hours</p>
//                     </div>
//                   </div>
//                 </div>
//                 <div className={`rounded-xl p-4 border ${getPriorityColor(workOrder.priority)}`}>
//                   <div className="flex items-center gap-3">
//                     <div className={`p-2 rounded-lg ${workOrder.priority === 'High' ? 'bg-red-100' : workOrder.priority === 'Medium' ? 'bg-amber-100' : 'bg-emerald-100'}`}>
...
//                     Description
//                   </h4>
//                   <p className="text-slate-600 text-sm leading-relaxed">{workOrder.description}</p>
//                 </div>
//               )}
...
//                           <div>
//                             <p className="text-xs text-slate-500">Additional Assignees</p>
//                             <p className="text-sm font-medium text-slate-800">
//                               {workOrder.additionalAssignees}
//                             </p>
//                           </div>
...
//                   <div>
//                     <span className="font-medium">Created:</span> {formatDate(workOrder.createdAt)}
//                   </div>
//                   <div>
//                     <span className="font-medium">Last Updated:</span> {formatDate(workOrder.updatedAt)}
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//                   <div key={checklist.id} className="bg-white rounded-xl border border-slate-200 overflow-hidden">
//                     <div className="bg-slate-50 px-4 py-3 border-b border-slate-200">
//                       <h4 className="font-semibold text-slate-800">{checklist.name}</h4>
//                     </div>
...
//                           <div className="flex-1">
//                             <p className="text-sm font-medium text-slate-800">{task.name || "Unnamed task"}</p>
//                             <div className="flex items-center gap-4 mt-1">
//                               <span className="text-xs text-slate-500">Status: {task.status}</span>
//                               {task.asset && (
//                                 <span className="text-xs text-slate-500">Asset: {task.asset}</span>
//                               )}
//                               {task.user && (
//                                 <span className="text-xs text-slate-500">User: {task.user}</span>
//                               )}
//                             </div>
//                           </div>
//                         </div>
