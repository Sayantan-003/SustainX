// //WOkOrderForm/WorkOrderForm.jsx:
// //Parent compoenet of the form
...
//         {isSubmitted && (
//           <div className="bg-emerald-50 border-2 border-emerald-200 rounded-2xl p-3 sm:p-4 flex items-center gap-2 sm:gap-3">
...
//         )}
//         {error && (
//           <div className="bg-red-50 border-2 border-red-200 rounded-2xl p-3 sm:p-4 flex items-center gap-2 sm:gap-3">
